...
export const getRouteState = createFeatureSelector<TransactionState>("transactions");

export const selectAllTransaction = createSelector(getRouteState, selectAll);
export const selectTransactions = createSelector(selectAllTransaction, (entries) =>
